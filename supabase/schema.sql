...
-- Dari sesi user: row baru mulai sebagai WAITING_FOR_SYNC tanpa grade; hasil
-- penilaian hanya ditulis Edge Function grade-catch; input model tetap; status
-- hanya WAITING_FOR_SYNC → LISTED dan → EXPIRED; listed_at/expires_at hanya dari
-- trigger set_catch_expiry. Untuk project yang sudah berjalan:
-- supabase/catches-lockdown.sql
...
--
-- Untuk project yang sudah berjalan: supabase/transaction-contact.sql
...
--
-- Untuk project yang sudah berjalan: supabase/cancel-transaction.sql
