...
export function ListingDrawer({ listing, labels, cancelHref, editHref, edit }: ListingDrawerProps) {
  ...
  // The panel runs the full height of the main column, so a long grid doesn't leave it short. Its content sticks to the
  // top of the window and is never taller than the window below the 81px header: the header and the Edit / Batalkan
  // footer stay in view and only the body between them scrolls.
  return (
    <aside
