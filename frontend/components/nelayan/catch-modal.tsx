...
// step — and its "Lanjut" button — without scrolling the page. On phones it fills the screen; the 720px card from md.
export function CatchModal({ title, subtitle, closeHref, closeLabel, steps, currentStep, children }: CatchModalProps) {
  return (
    <div className="box-border fixed inset-0 overflow-y-auto overscroll-contain flex flex-col gap-0 p-0 sm:p-[16px] justify-start items-center bg-[#0B3B5CA6] z-[60] lg:z-[2]">
      <ScrollLock />
      <div
        role="dialog"
        aria-modal="true"
