...
// The white login card: heading, then the card's sections on its 28px rhythm.
export function AuthCard({ backLink, title, subtitle, children }: AuthCardProps) {
  return (
    <div className="box-border w-[580px] h-fit [box-shadow:0px_0px_0px_1px_#0000000F,_0px_1px_2px_-1px_#0000000F,_0px_16px_40px_0px_#0B3B5C14] flex flex-col gap-[28px] p-[48px] justify-start items-start bg-[#FFFFFF] rounded-[24px]">
