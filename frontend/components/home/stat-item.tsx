...
export function StatItem({ icon, accent, value, caption }: Stat) {
  ...
  return (
    <div className="box-border w-full lg:w-fit shrink-0 h-fit flex flex-row gap-[14px] justify-start items-center">
      <div
      ...
      <div className="box-border w-fit min-w-0 shrink lg:shrink-0 h-fit flex flex-col gap-[2px] justify-start items-start">
