...
// The account menu behind the header pill and the sidebar user card: "Akun", then "Keluar" under a divider. The
// language is switched from the header instead (components/ui/language-switcher.tsx).
