...
export function PpiMap({ label, loadingLabel, ...canvas }: PpiMapProps) {
  return (
    <aside
      aria-label={label}
      className="box-border w-full lg:w-[420px] shrink-0 self-stretch h-[320px] sm:h-[400px] lg:h-auto min-h-[320px] bg-[#DCEEFB] [border:1px_solid_#E2E8F0] rounded-[20px] overflow-hidden relative isolate"
    >
